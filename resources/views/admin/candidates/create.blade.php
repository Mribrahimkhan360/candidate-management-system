                    ...
                    <form action="{{ route('candidates.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="experience_years" id="experience_years" value="{{ old('experience_years') }}" required min="0"
                            ...
                            <div>
                                ...
                                <input type="number" name="age" id="age" value="{{ old('age') }}" required min="18" max="100"
